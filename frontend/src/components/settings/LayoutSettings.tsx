...
export function LayoutSettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-sm font-medium text-c-text mb-1">Layout</h3>
        <p className="text-xs text-c-text-faint mb-4">
              ...
              <button
                ...
                className={`px-3 py-2 text-sm rounded border transition-colors ${
                  isActive
                    ...
                    : "bg-c-element border-c-line-soft text-c-text-sub hover:bg-c-hover hover:border-c-line"
                }`}
              >
                {preset.label}
              </button>
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1">
            <label className="block text-xs text-c-text-faint mb-1">Width</label>
            <input
              type="number"
              ...
              min={800}
              max={3840}
              className="w-full px-3 py-2 bg-c-element border border-c-line-soft rounded text-sm text-c-text focus:outline-none focus:border-blue-500"
            />
          </div>
          <span className="text-c-text-faint pt-5">×</span>
          <div className="flex-1">
            <label className="block text-xs text-c-text-faint mb-1">Height</label>
            <input
              type="number"
      ...
      <div>
        <label className="block text-sm font-medium text-c-text-sub mb-2">
          Left Sidebar Width
          <span className="ml-2 text-c-text-faint font-normal">{settings.layout.sidebarWidth}px</span>
        </label>
        <input
          type="range"
          ...
          className="w-full h-2 bg-c-element rounded-lg appearance-none cursor-pointer accent-blue-600"
        />
      ...
      <div>
        <label className="block text-sm font-medium text-c-text-sub mb-2">
          ...
          <span className="ml-2 text-c-text-faint font-normal">{settings.layout.detailsPanelWidth}px</span>
        </label>
        <input
          type="range"
      ...
      <div className="p-3 bg-c-element/50 rounded text-sm text-c-text-dim">
